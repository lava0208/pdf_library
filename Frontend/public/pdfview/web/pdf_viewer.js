...
class PDFViewer {
  ...
  initializeForm() {
    ...
    $(".form-fields").each(function () {
      ...
      if(id.includes("checkbox") || id.includes("radio") || id.includes("text") || id.includes("button") || id.includes("list") || id.includes("signature") || id.includes("shape") || id.includes("photo")){
