    ...
    <button
      ...
      ${
        props.size == null || props.size === "md"
          ? "h-8 px-2 py-1 xl:px-3 xl:py-2 text-sm font-semibold"
          : ""
      }
      ${props.size === "lg" ? "h-816 text-md font-semibold" : ""}
      ${
        props.variant == null || props.variant === "normal"
          ? "hover:bg-blue-200 border dark:border-slate-700 hover:bg-primary-500  dark:hover:bg-blue-700"
          : ""
      }
      ${
        props.variant === "danger"
          ? " text-red-600 hover:bg-red-500 border border-red-600/20 hover:border-red-700 hover:text-white"
          : ""
      }
      ${
        props.variant === "ghost"
          ? "hover:bg-blue-200 hover:bg-primary-500  dark:hover:bg-blue-700 "
          : ""
      }
        `}
    ...
    >
      {props.isLoading && (
        <div className="button-container">
          ...
          <div>{props.loadingText || "Loading..."}</div>
        </div>
      )}
      {
        !props.isLoading && (
