...
let checkboxBorderColorPickerInitialized = false;
let radioBackgroundColorPickerInitialized = false;
let radioBorderColorPickerInitialized = false;
...
let shapeBackgroundColorPickerInitialized = false;
let shapeBorderColorPickerInitialized = false;
let shapeFontColorPickerInitialized = false;
...
let numberBackgroundColorPickerInitialized = false;
let numberBorderColorPickerInitialized = false;
let numberFontColorPickerInitialized = false;
let textFieldFontColorPickerInitialized = false;

let checkboxBackgroundColor = "#BBE9FF";
let checkboxBorderColor = "#FFFFFF";
let radioBackgroundColor = "#BBE9FF";
let radioboxBorderColor = "#FFFFFF";
let textBackgroundColor = "#BBE9FF";
let textBorderColor = "#FFFFFF";
let textFontColor = "#000000";
let comboBackgroundColor = "#BBE9FF";
let comboBorderColor = "#FFFFFF";
let comboFontColor = "#000000";
let listBackgroundColor = "#BBE9FF";
let listBorderColor = "#FFFFFF";
let listFontColor = "#000000";
let signatureBackgroundColor = "#BBE9FF";
let signatureBorderColor = "#FFFFFF";
let signatureDrawingColor = "#000000";
let signatureTypeingColor = "#000000";
let shapeBackgroundColor = "#BBE9FF";
let shapeBorderColor = "#FFFFFF";
let shapeFontColor = "#000000";
let photoBackgroundColor = "#BBE9FF";
let photoBorderColor = "#FFFFFF";
let dateBackgroundColor = "#BBE9FF";
let dateBorderColor = "#FFFFFF";
let dateFontColor = "#000000";
let buttonBackgroundColor = "#BBE9FF";
let buttonBorderColor = "#FFFFFF";
let buttonFontColor = "#000000";
let numberBackgroundColor = "#BBE9FF";
let numberBorderColor = "#FFFFFF";
let numberFontColor = "#000000";
let textFieldFontColor = "#000000";
