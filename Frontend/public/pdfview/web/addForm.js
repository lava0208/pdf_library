    ...
    form_storage.forEach((item) => {
      ...
      switch (item.form_type) {
            ...
            if (checkboxBackgroundColorElement) {
              new GridColorPicker(checkboxBackgroundColorElement, {
                ...
                callback: (selectedColor) => {
                  checkboxBackgroundColor = selectedColor;
                },
              });
        ...
        case RADIO:
          ...
          if (!radioBackgroundColorPickerInitialized) {
        ...
        case TEXTFIELD:
          ...
          if (!textBackgroundColorPickerInitialized) {
            ...
            if(backgroundColorElement){
              ...
              textBackgroundColorPickerInitialized = true;
              textBackgroundColor = "#BBE9FF";
            }
          }

          if (!textBorderColorPickerInitialized) {
          ...
          if (!textFontColorPickerInitialized) {
        ...
        case COMBOBOX:
          ...
          if (!comboBackgroundColorPickerInitialized) {
            ...
            if(backgroundColorElement){
              ...
              comboBackgroundColorPickerInitialized = true;
              comboBackgroundColor = "#BBE9FF";
            }
          }

          if (!comboBorderColorPickerInitialized) {
                  ...
                  form_storage.map((element) => {
                    if (element.id == id) {
                      ...
                      document.getElementById("combo-border-width").value =
                        element.borderWidth;
                      document.getElementById("combo-background-colorpicker").value =
                        element.textBackgroundColor;
                      document.getElementById("combo-background-colorpicker_autocomplete").style.backgroundColor =
                        element.textBackgroundColor;
                      document.getElementById("combo-border-colorpicker").value =
                        element.borderColor;
                      document.getElementById("combo-border-colorpicker_autocomplete").style.backgroundColor =
                        element.borderColor;
                      document.getElementById("combo-font-colorpicker").value =
                        element.textColor;
        ...
        case LIST:
          ...
          if (!listBackgroundColorPickerInitialized) {
            ...
            if(backgroundColorElement){
              ...
              listBackgroundColorPickerInitialized = true;
              listBackgroundColor = "#BBE9FF";
            }
          }

          if (!listBorderColorPickerInitialized) {
                ...
                if (!islisttooltipshow) {
                  ...
                  form_storage.map((element) => {
                    if (element.id == id) {
                      ...
                      document.getElementById("list-background-colorpicker").value =
                        element.textBackgroundColor;
                      document.getElementById("list-background-colorpicker_autocomplete").style.backgroundColor =
                        element.textBackgroundColor;
                      document.getElementById("list-border-colorpicker").value =
                        element.borderColor;
                      document.getElementById("list-border-colorpicker_autocomplete").style.backgroundColor =
                        element.borderColor;
                      document.getElementById("list-font-colorpicker").value =
                        element.textColor;
                      document.getElementById("list-font-colorpicker_autocomplete").style.backgroundColor =
                        element.textColor;
        ...
        case BUTTON:
          ...
          if (!buttonBackgroundColorPickerInitialized) {
            ...
            if(backgroundColorElement){
              ...
              buttonBackgroundColorPickerInitialized = true;
              buttonBackgroundColor = "#BBE9FF";
            }
          }

          if (!buttonBorderColorPickerInitialized) {
                ...
                if (!isbuttontooltipshow) {
                  ...
                  form_storage.map((element) => {
                    if (element.id == id) {
                      ...
                      document.getElementById("button-background-colorpicker").value =
                        element.textBackgroundColor;
                      document.getElementById("button-background-colorpicker_autocomplete").style.backgroundColor =
                        element.textBackgroundColor;
                      document.getElementById("button-border-colorpicker").value =
                        element.borderColor;
                      document.getElementById("button-border-colorpicker_autocomplete").style.backgroundColor =
                        element.borderColor;
                      document.getElementById("button-font-colorpicker").value =
                        element.textColor;
                      document.getElementById("button-font-colorpicker_autocomplete").style.backgroundColor =
                        element.textColor;
        ...
        case DATE:
          ...
          if (!dateBackgroundColorPickerInitialized) {
            ...
            if(backgroundColorElement){
              ...
              dateBackgroundColorPickerInitialized = true;
              dateBackgroundColor = "#BBE9FF";
            }
          }

          if (!dateBorderColorPickerInitialized) {
                ...
                if (!isdatetooltipshow) {
                  ...
                  form_storage.map((element) => {
                    if (element.id == id) {
                      ...
                      document.getElementById("date-background-colorpicker").value =
                        element.textBackgroundColor;
                      document.getElementById("date-background-colorpicker_autocomplete").style.backgroundColor =
                        element.textBackgroundColor;
                      document.getElementById("date-border-colorpicker").value =
                        element.borderColor;
                      document.getElementById("date-border-colorpicker_autocomplete").style.backgroundColor =
                        element.borderColor;
                      document.getElementById("date-font-colorpicker").value =
                        element.textColor;
                      document.getElementById("date-font-colorpicker_autocomplete").style.backgroundColor =
                        element.textColor;
        ...
        case SIGNATURE:
          ...
          form_storage.map((element) => {
            if (element.id == id) {
              document.getElementById("signature-background-colorpicker").value =
                element.textBackgroundColor;
              document.getElementById("signature-background-colorpicker_autocomplete").style.backgroundColor =
                element.textBackgroundColor;
              document.getElementById("signature-border-colorpicker").value =
                element.borderColor;
        ...
        case PHOTO:
          ...
          if (!photoBackgroundColorPickerInitialized) {
            ...
            if(backgroundColorElement){
              ...
              photoBackgroundColorPickerInitialized = true;
              photoBackgroundColor = "#BBE9FF";
            }
          }

          if (!photoBorderColorPickerInitialized) {
          ...
          form_storage.map((element) => {
            if (element.id == id) {
              document.getElementById("photo-background-colorpicker").value =
                element.textBackgroundColor;
              document.getElementById("photo-background-colorpicker_autocomplete").style.backgroundColor =
                element.textBackgroundColor;
              document.getElementById("photo-border-colorpicker").value =
                element.borderColor;
              document.getElementById("photo-border-colorpicker_autocomplete").style.backgroundColor =
                element.borderColor;
        ...
        case NUMBERFIELD:
          ...
          if (!numberBackgroundColorPickerInitialized) {
            ...
            if(backgroundColorElement){
              ...
              numberBackgroundColorPickerInitialized = true;
              numberBackgroundColor = "#BBE9FF";
            }
          }

          if (!numberBorderColorPickerInitialized) {
          ...
          if (!numberFontColorPickerInitialized) {
                ...
                if (!isnumbertooltipshow) {
                  ...
                  form_storage.map((element) => {
                    if (element.id == id) {
                      ...
                      document.getElementById("number-background-colorpicker").value =
                        element.textBackgroundColor;
                      document.getElementById("number-background-colorpicker_autocomplete").style.backgroundColor =
                        element.textBackgroundColor;
                      document.getElementById("number-border-colorpicker").value =
                        element.borderColor;
                      document.getElementById("number-border-colorpicker_autocomplete").style.backgroundColor =
                        element.borderColor;
                      document.getElementById("number-font-colorpicker").value =
                        element.textColor;
                      document.getElementById("number-font-colorpicker_autocomplete").style.backgroundColor =
                        element.textColor;                        
    ...
    if (form_storage[i].id == current_form_id) {
      if (!isEditing) {
        if (!isOpenEmailPdf) {
          ...
          form_storage[i].borderColor = textBorderColor;
          form_storage[i].textColor = textFontColor;
          form_storage[i].borderWidth = borderWidth;
          form_storage[i].form_field_name = formFieldName;
...
const handleCombo = function (e) {
    ...
    if (form_storage[i].id == current_form_id) {
      if (!isEditing) {
        if (!isOpenEmailPdf) {
          ...
          form_storage[i].fontSize = fontSize;
          form_storage[i].regularFontStyle = regularFont;
          form_storage[i].textBackgroundColor = comboBackgroundColor;
          form_storage[i].borderColor = comboBorderColor;
          form_storage[i].textColor = comboFontColor;
          form_storage[i].borderWidth = borderWidth;
          form_storage[i].form_field_name = formFieldName;
  ...
  if (baseId !== 0 && count == form_storage.length && isDelete === false) {
    form_storage.push({
      ...
      yPage: formHeight,
      isReadOnly: false,
      textBackgroundColor: comboBackgroundColor,
      borderColor: comboBorderColor,
      textColor: comboFontColor,
    });
    fontStyle = "";
    fontSize = 12;    
    borderWidth = "";
...
const handleList = function (e) {
    ...
    if (form_storage[i].id == current_form_id) {
      if (!isEditing) {
        if (!isOpenEmailPdf) {
          ...
          form_storage[i].fontSize = fontSize;
          form_storage[i].regularFontStyle = regularFont;
          form_storage[i].textBackgroundColor = listBackgroundColor;
          form_storage[i].borderColor = listBorderColor;
          form_storage[i].textColor = listFontColor;
          form_storage[i].borderWidth = borderWidth;
          form_storage[i].form_field_name = formFieldName;
  ...
  if (baseId !== 0 && count == form_storage.length && isDelete === false) {
    form_storage.push({
      ...
      yPage: formHeight,
      isReadOnly: false,
      textBackgroundColor: listBackgroundColor,
      borderColor: listBorderColor,
      textColor: listFontColor,
    });
    fontStyle = "";
    fontSize = 12;
    borderWidth = "";
...
const handleButton = function (e) {
    ...
    if (form_storage[i].id == current_form_id) {
      if (!isEditing) {
        if (!isOpenEmailPdf) {
          ...
          form_storage[i].align = alignValue;
          form_storage[i].textBackgroundColor = buttonBackgroundColor;
          form_storage[i].borderColor = buttonBorderColor;
          form_storage[i].textColor = buttonFontColor;
          form_storage[i].borderWidth = borderWidth;
          form_storage[i].form_field_name = formFieldName;
  ...
  if (baseId !== 0 && count == form_storage.length && isDelete === false) {
    form_storage.push({
      ...
      yPage: formHeight,
      isReadOnly: false,
      textBackgroundColor: buttonBackgroundColor,
...
const handleDate = function (e) {
    ...
    if (form_storage[i].id == current_form_id) {
      if (!isEditing) {
        if (!isOpenEmailPdf) {
          ...
          form_storage[i].textBackgroundColor = dateBackgroundColor;
          form_storage[i].borderColor = dateBorderColor;
          form_storage[i].textColor = dateFontColor;
          form_storage[i].borderWidth = borderWidth;
          form_storage[i].form_field_name = formFieldName;
  ...
  if (baseId !== 0 && count == form_storage.length && isDelete === false) {
    form_storage.push({
      ...
      textBackgroundColor: dateBackgroundColor,
      borderColor: dateBorderColor,
      textColor: dateFontColor,
    });
    fontStyle = "";
    fontSize = 12;
    borderWidth = "";
...
const handlePhoto = function () {
  ...
  for (let i = 0; i < form_storage.length; i++) {
    if (
      ...
      form_storage[i].textBackgroundColor = photoBackgroundColor;
      form_storage[i].borderColor = photoBorderColor;
      form_storage[i].borderWidth = borderWidth;
  ...
  if (baseId !== 0 && (count == imageStorage.length || imageStorage == null) && isDelete === false) {
    form_storage.push({
      ...
      photoData: photoData,
      borderWidth: borderWidth,
      textBackgroundColor: photoBackgroundColor,
...
const handleNumber = function (e) {
    ...
    if (form_storage[i].id == current_form_id) {
      if (!isEditing) {
        if (!isOpenEmailPdf) {
          ...
          form_storage[i].textColor = numberFontColor;
          form_storage[i].textBackgroundColor = numberBackgroundColor;
          form_storage[i].borderColor = numberBorderColor;
  ...
  if (baseId !== 0 && count == form_storage.length && isDelete === false) {    
    form_storage.push({
      ...
      yPage: formHeight,
      isReadOnly: false,
      textBackgroundColor: numberBackgroundColor,
      borderColor: numberBorderColor,
      textColor: numberFontColor,
    });
    fontStyle = "";
    fontSize = 12;
    borderWidth = "";
...
const addFormElementStyle = function (object, top, left, width, height, borderRadius="0") {  
  ...
  object.style.background = "#BBE9FF";
