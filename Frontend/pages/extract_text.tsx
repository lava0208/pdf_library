    ...
    return (
        ...
        >
            <div className="flex justify-between">
                <h4 className="text-blue-700 dark:text-blue-400 text-lg font-medium my-1">
                    {props.label}
                </h4>
...
const ExtractText = () => {
    ...
    return (
        <>
            <Header text="Extract text from PDF Document" icon="export.svg" />
            ...
            <div className="w-full flex justify-center my-4">
                {
                    file && (
                        <Button
                            ...
                            >
                            <img src="images/export.svg" width={18} />
                            Extract Text
                        </Button>
                    )
                }
            ...
            {textContentPerPages !== undefined && (
                <div className="px-5">
                    <div className="w-fit mx-auto text-center my-2">
                        <h3 className="text-2xl font-semibold text-black-500 dark:text-black-400">
                            Extract PDF Text
                        </h3>
                        <details className=" text-gray-700 dark:text-gray-300 px-2 p-1 rounded-md border bg-slate-50 dark:bg-slate-800 dark:border-slate-600">
                            ...
                            <p className="mx-auto my-2 text-sm">
                                Below the text contents of all pages are displayed and can be
                                copied using the button on the right.
                            </p>
                        </details>
                    </div>
                    <div className="flex">
                        <TextContentTextarea
                            text={textContentPerPages.join("/n")}
                            label="All pages"
                            highlighted={true}
                        />
                    </div>
