...
const ReorderPages = () => {
    ...
    async function downloadReorderedPDF() {
        ...
        for (const pageIndex of resPDF1.getPageIndices()) {
            if (
                ...
                typeof pageOrder[pageIndex] !== "undefined"
            ) {
    ...
    return (
        <div>
            <Header text="Reorder or remove pages" icon="order.png" />
                    ...
                    <div className="w-fit mx-auto text-center my-4">
                        ...
                        <details className=" text-gray-700 dark:text-gray-300 px-2 p-1 rounded-md border bg-slate-50 dark:bg-slate-800 dark:border-slate-600">
                            ...
                            <p className="mx-auto my-2 text-sm">
                                ...
                                <br />
                                Finally, download the processed PDF using the{" "}
                                <i>Download Result</i> button.
                            </p>
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    setPageOrder(
                                        [...Array(pdfDoc.numPages).keys()].map((i) => ({ id: i }))
                                    );
                                }}
                            >
                                Reset Pages
                            ...
                            <li
                                onContextMenu={(ev) => {
                                    ...
                                    try {
                                        ...
                                        if (
                                            newIndexParsed >= 1 &&
                                            newIndexParsed <= pdfDoc.numPages
                                        ) {
